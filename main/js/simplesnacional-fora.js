document.getElementById('formFiscal').addEventListener('submit', function(e) {
    ...
    const intra = [
      'Natureza de Operação de Vendas - Simples Nacional ( Fora do Estado )',
    ...
    doc1.save('Natureza de Operação de Vendas - Simples Nacional ( Fora do Estado ).pdf');
  
    window.location.href = 'simplesnacional-devolucao-dentro.html';
  });
